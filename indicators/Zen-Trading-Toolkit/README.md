# Zen Trading Toolkit v1.8.2

Three research modules in one indicator, each independently toggleable.

- **Module 1 — ABR Measured Moves** from yesterday's close (0.5x / 1x / 1.5x / 2x), plus yesterday's-range-extremes MM at 1x and 2x
...
2. Paste the contents of `zen-trading-toolkit-v1.8.2.pine`
3. Save → Add to chart
4. Settings → pick your instrument

## Notes

- v1.8.2 adds a "Yesterday's Range MM (2x from extremes)" toggle alongside the existing 1x line — same yHigh/yLow-based measured move, just doubled. Off by default, under "M1: Reference Lines".
